...
public final class ItemSwipeHelperTest extends BaseInstrumentedTest {

	@SuppressWarnings("unused")
	private static final String TAG = "ItemSwipeHelperTest";
	...
	public void testRestoreHolderForHorizontalSwipe() throws Throwable {
		...
		final Holder mockViewHolder = createMockHolder(mMockRecyclerView, itemView);
	...
	public void testRestoreHolderWithUnknownPosition() throws Exception {
		final View itemView = new View(mContext);
		final Holder mockViewHolder = createMockHolder(null, itemView);
	...
	public void testRestoreHolderNotTypeOfSwipeHolder() throws Exception {
		assertThat(new ItemSwipeHelper().restoreHolder(new RecyclerView.ViewHolder(new View(mContext)) {}, ItemSwipeHelper.START), is(false));
	}

	private static Holder createMockHolder(RecyclerView ownerRecyclerView, View itemView) throws Exception {
