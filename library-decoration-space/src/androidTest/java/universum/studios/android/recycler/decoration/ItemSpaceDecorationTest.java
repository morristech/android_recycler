...
public final class ItemSpaceDecorationTest extends BaseInstrumentedTest {
    
	@SuppressWarnings("unused")
	private static final String TAG = "ItemSpaceDecorationTest";
	...
	public void testInstantiationWithContext() {
		final ItemSpaceDecoration decoration = new ItemSpaceDecoration(mContext);
	...
	public void testInstantiationWithContextAttrsSet() {
		final ItemSpaceDecoration decoration = new ItemSpaceDecoration(mContext, null);
		assertThat(decoration.skipsFirst(), is(false));
		assertThat(decoration.skipsLast(), is(false));
	}
	...
	public void testInstantiationWithContextAttrsSetDefStyleAttr() {
		final ItemSpaceDecoration decoration = new ItemSpaceDecoration(mContext, null, 0);
		assertThat(decoration.skipsFirst(), is(false));
		assertThat(decoration.skipsLast(), is(false));
	}
